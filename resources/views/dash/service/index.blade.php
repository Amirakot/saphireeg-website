...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"> service </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Show</span>
						</div>
					</div>
									...
									<table class="table text-md-nowrap " id="example1">
                                        ...
                                        @foreach($services as $service)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success" href="{{ route('service.edit',$service->id) }}"><i class="fe fe-edit"></i></a>
                                                </td>
                                                   <td>
