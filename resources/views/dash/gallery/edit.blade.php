...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">gallery </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard/section.update') }}</span>
						</div>
					</div>
...
<form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ route('gallery.update',$gallery->id) }}">
    @csrf
    @method('PUT')

    <div class="form-group">
        <label>title</label>
        <input type="text" class="form-control" value="{{ $gallery->title }}" name='title' id="inputName" >
    </div>
...
<div class="form-group">
        ...
        <br>
             ...
             <img src="{{asset($gallery->image)}}"  id="image" alt="image" width="50">
