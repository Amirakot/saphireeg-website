...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"> slider image </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ADD</span>
						</div>
					</div>
					...
					<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
						<div class="card  box-shadow-0">
							...
							<div class="card-body pt-0">
								<form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('slider.store')}}" >
                                    @csrf
									<div class="form-group">
                                        <label for="inputName">title</label>
										<input type="text" class="form-control" value="{{ old('title') }}" name='title' id="inputName" placeholder="enter title slider">
									 @error('title')
